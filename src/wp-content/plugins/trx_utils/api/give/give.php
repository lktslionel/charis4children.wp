...
if ( !function_exists( 'trx_utils_exists_give' ) ) {
	function trx_utils_exists_give() {
...
if ( !function_exists( 'trx_utils_give_importer_required_plugins' ) ) {
	if (is_admin()) add_filter( 'trx_utils_filter_importer_required_plugins',	'trx_utils_give_importer_required_plugins', 10, 2 );
	function trx_utils_give_importer_required_plugins($not_installed='', $list='') {
		if (strpos($list, 'give')!==false && !trx_utils_exists_give() )
			$not_installed .= '<br>' . esc_html__('Give', 'trx_utils');
