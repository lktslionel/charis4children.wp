...
/* Theme setup section
-------------------------------------------------------------------- */
if (!function_exists('charity_is_hope_sc_countdown_theme_setup')) {
	add_action( 'charity_is_hope_action_before_init_theme', 'charity_is_hope_sc_countdown_theme_setup' );
	function charity_is_hope_sc_countdown_theme_setup() {
		add_action('charity_is_hope_action_shortcodes_list', 		'charity_is_hope_sc_countdown_reg_shortcodes');
		if (function_exists('charity_is_hope_exists_visual_composer') && charity_is_hope_exists_visual_composer())
			add_action('charity_is_hope_action_shortcodes_list_vc','charity_is_hope_sc_countdown_reg_shortcodes_vc');
	}
}
...
if (!function_exists('charity_is_hope_sc_countdown')) {	
	function charity_is_hope_sc_countdown($atts, $content = null) {
		...
		wp_enqueue_script( 'charity_is_hope-jquery-plugin-script', charity_is_hope_get_file_url('js/countdown/jquery.plugin.js'), array('jquery'), null, true );
		wp_enqueue_script( 'charity_is_hope-countdown-script', charity_is_hope_get_file_url('js/countdown/jquery.countdown.js'), array('jquery'), null, true );
		$output = '<div' . ($id ? ' id="'.esc_attr($id).'"' : '')
			...
			. '>'
				...
				. ($align=='center' ? '</div>' : '')
			. '</div>';
		return apply_filters('charity_is_hope_shortcode_output', $output, 'trx_countdown', $atts, $content);
	}
	charity_is_hope_require_shortcode("trx_countdown", "charity_is_hope_sc_countdown");
}
...
-------------------------------------------------------------------- */
if ( !function_exists( 'charity_is_hope_sc_countdown_reg_shortcodes' ) ) {
	//add_action('charity_is_hope_action_shortcodes_list', 'charity_is_hope_sc_countdown_reg_shortcodes');
	function charity_is_hope_sc_countdown_reg_shortcodes() {
	
		charity_is_hope_sc_map("trx_countdown", array(
...
-------------------------------------------------------------------- */
if ( !function_exists( 'charity_is_hope_sc_countdown_reg_shortcodes_vc' ) ) {
	//add_action('charity_is_hope_action_shortcodes_list_vc', 'charity_is_hope_sc_countdown_reg_shortcodes_vc');
	function charity_is_hope_sc_countdown_reg_shortcodes_vc() {
		...
		class WPBakeryShortCode_Trx_Countdown extends CHARITY_IS_HOPE_VC_ShortCodeSingle {}
	}
}
?>