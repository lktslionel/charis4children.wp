...
/* Theme setup section
-------------------------------------------------------------------- */
if (!function_exists('charity_is_hope_sc_price_theme_setup')) {
	add_action( 'charity_is_hope_action_before_init_theme', 'charity_is_hope_sc_price_theme_setup' );
	function charity_is_hope_sc_price_theme_setup() {
		add_action('charity_is_hope_action_shortcodes_list', 		'charity_is_hope_sc_price_reg_shortcodes');
		if (function_exists('charity_is_hope_exists_visual_composer') && charity_is_hope_exists_visual_composer())
			add_action('charity_is_hope_action_shortcodes_list_vc','charity_is_hope_sc_price_reg_shortcodes_vc');
	}
}
...
if (!function_exists('charity_is_hope_sc_price')) {	
	function charity_is_hope_sc_price($atts, $content=null){	
		...
		return apply_filters('charity_is_hope_shortcode_output', $output, 'trx_price', $atts, $content);
	}
	charity_is_hope_require_shortcode('trx_price', 'charity_is_hope_sc_price');
}
...
-------------------------------------------------------------------- */
if ( !function_exists( 'charity_is_hope_sc_price_reg_shortcodes' ) ) {
	//add_action('charity_is_hope_action_shortcodes_list', 'charity_is_hope_sc_price_reg_shortcodes');
	function charity_is_hope_sc_price_reg_shortcodes() {
	
		charity_is_hope_sc_map("trx_price", array(
...
-------------------------------------------------------------------- */
if ( !function_exists( 'charity_is_hope_sc_price_reg_shortcodes_vc' ) ) {
	//add_action('charity_is_hope_action_shortcodes_list_vc', 'charity_is_hope_sc_price_reg_shortcodes_vc');
	function charity_is_hope_sc_price_reg_shortcodes_vc() {
		...
		class WPBakeryShortCode_Trx_Price extends CHARITY_IS_HOPE_VC_ShortCodeSingle {}
	}
}
?>