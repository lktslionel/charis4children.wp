...
$options = array(
	...
	'layout_header' => array(
		...
		/* array(
			'name' 		=> esc_html__( 'Show slide widget area', 'onelove'),
			'id' 		=> 'show_slideout_widget',
			'type' 		=> 'checkbox',
			'std' 		=> catanis_option('show_slideout_widget'),
			's_desc' 	=> esc_html__( 'Show or hide slide out widget area icon.', 'onelove')
		), */
		array(
	...
	'single_post' => array(
		...
		array(
			'name' 		=> esc_html__( 'Post Thumbnail Sizing', 'onelove' ),
			'id' 		=> 'post_thumbnail_type',
			'type' 		=> 'select',
			'extClass' 	=> 'hide',
			'options' 	=> Catanis_Default_Data::metaOptions('portfolio-thumbnail-type'),
			's_desc' 	=> esc_html__( 'This will only be used if you choose to display your post in the masonry format.', 'onelove' ),
			'std' 		=> 'default',
		),
		array(
			'name' 		=> esc_html__( 'Show Related Post', 'onelove' ),
			'id' 		=> 'show_related_post',
			'type' 		=> 'checkbox',
			'std' 		=> catanis_option ( 'blog_single_display_related' ),
			's_desc' 	=> esc_html__( 'If ON, the related post will be display.', 'onelove' )
		),
		array(
			'name' 		=> esc_html__( 'Show Author Biographical', 'onelove' ),
			'id' 		=> 'show_author_bio',
			'type' 		=> 'checkbox',
			'std' 		=> false,
			's_desc' 	=> esc_html__( 'If ON, the author biographical info will be display.', 'onelove' )
		),
		array(
			'name' 		=> esc_html__( 'Enable Comments', 'onelove' ),
			'id' 		=> 'comment_enable',
			'type' 		=> 'checkbox',
			'std' 		=> catanis_option ( 'blog_single_display_comment' ),
			's_desc' 	=> esc_html__( 'Enable/disable page comment.', 'onelove' )
		),
	),
	'post_format' => array(
		array(
			'title' 	=> '<span class="icon-popup"></span>'. esc_html__( 'Post Format Settings', 'onelove' ),
			'type' 	 	=> 'heading',
		), 
		array(
			'name' 		=> esc_html__( 'Video type', 'onelove' ),
		...
		array(
			...
			'large'		=> true,
			'extClass'	=> 'video_format',
			'data'		=> array('depend'=> 'video_type', 'value' => 'youtube'),
			's_desc' 	=> esc_html__( 'Input Youtube Video URL here.', 'onelove' )
		),
		array(
			'name' 		=> esc_html__( 'Video Vimeo URL', 'onelove' ),
			...
			'large'		=> true,
			'extClass'	=> 'video_format',
			'data'		=> array('depend'=> 'video_type', 'value' => 'vimeo'),
			's_desc' 	=> esc_html__( 'Input Vimeo Video URL here.', 'onelove' )
		),
		array(
			'name' 		=> esc_html__( 'MP4 Video URL', 'onelove' ),
			...
			'large'		=> true,
			'extClass'	=> 'video_format',
			'data'		=> array('depend'=> 'video_type', 'value' => 'hosted'),
			's_desc' 	=> esc_html__( 'Video url is required here if self hosted option is selected.', 'onelove' )
		),
		array(
			'name' 		=> esc_html__( 'OGG Video URL', 'onelove' ),
		...
		array(
			'name' 		=> esc_html__( 'Audio type', 'onelove' ),
			'id' 		=> 'audio_type',
			'type' 		=> 'select',
			'extClass' 	=> 'border0 audio_format catanis-select-parent',
			'std' 		=> 'mp3',
			'options' 	=> array(
				array( 'id' => 'mp3', 'name' => 'Audio MP3' ),
				array( 'id' => 'soundcloud', 'name' => 'Audio Soundcloud' )
			),
			's_desc' 	=> esc_html__( 'Select audio type.', 'onelove' )
		),
		array(
			...
			'type' 		=> 'text',
			'large'		=> true,
			'extClass'	=> 'audio_format',
			'data'		=> array('depend'=> 'audio_type', 'value' => 'mp3'),
		...
		array(
			...
			'large'		=> true,
			'extClass'	=> 'audio_format',
			'data'		=> array('depend'=> 'audio_type', 'value' => 'soundcloud'),
			's_desc' 	=> esc_html__( 'Soundcloud shortcode is required here if "Audio Soundcloud" option is selected.', 'onelove' )
		),
			
		array(
			"name" 		=> esc_html__( 'Gallery', 'onelove' ),
			"id" 		=> 'gallery_items',
			"type" 		=> 'multiupload',
			'extClass'	=> 'gallery_format border0',
			"s_desc"	=> esc_html__( 'Choose some images for gallery.', 'onelove' )
		),
			
		array(
			'name' 		=> esc_html__( 'Quote Content', 'onelove' ),
			'id' 		=> 'quote_content',
			'type' 		=> 'text',
			'large'		=> true,
			'extClass'	=> 'quote_format border0',
			's_desc' 	=> esc_html__( 'Add block quote content.', 'onelove' )
		),
		array(
			'name' 		=> esc_html__( 'Quote Author', 'onelove' ),
			'id' 		=> 'quote_author',
			'type' 		=> 'text',
			'large'		=> true,
			'extClass'	=> 'quote_format',
			's_desc' 	=> esc_html__( 'Add block quote author.', 'onelove' )
		),
			
		array(
			'name' 		=> esc_html__( 'Link Text', 'onelove' ),
			'id' 		=> 'link_text',
			'type' 		=> 'text',
			'large'		=> true,
			'extClass'	=> 'link_format border0',
			's_desc' 	=> esc_html__( 'Add link text here.', 'onelove' )
		),
		array(
			'name' 		=> esc_html__( 'Link URL', 'onelove' ),
			'id' 		=> 'link_url',
			'type' 		=> 'text',
			'large'		=> true,
			'extClass'	=> 'link_format',
			's_desc' 	=> esc_html__( 'Add link URL here.', 'onelove' )
		),
		array(
			'text' 		=> wp_kses( __( '<span>Note:</span> To see different fields post format Please change radio button on metabox <b>FORMAT</b> in the right sidebar', 'onelove' ), array('span', 'br', 'b') ),
			'id' 		=> 'documentation',
			'type' 		=> 'documentation',
			'extClass'	=> 'docs_format border0'
		)
	)
