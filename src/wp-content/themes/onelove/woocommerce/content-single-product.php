...
$classes_extend = 'cata-product-single cata-item';
...
if( $vertical_thumbnails ){
	$classes_extend .= ' cata-vertical-thumbnail';
}
?>

<div id="product-<?php the_ID(); ?>" <?php wc_product_class($classes_extend); ?>>
	<div class="cata-product-wrapper">
		<?php
			do_action( 'catanis_hook_top_single_product' );
