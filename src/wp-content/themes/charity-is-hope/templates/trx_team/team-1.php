...
if ( !function_exists( 'charity_is_hope_template_team_1_theme_setup' ) ) {
	add_action( 'charity_is_hope_action_before_init_theme', 'charity_is_hope_template_team_1_theme_setup', 1 );
	function charity_is_hope_template_team_1_theme_setup() {
		charity_is_hope_add_template(array(
			'layout' => 'team-1',
			'template' => 'team-1',
			'mode'   => 'team',
			'title'  => esc_html__('Team /Style 1/', 'charity-is-hope'),
...
// Template output
if ( !function_exists( 'charity_is_hope_template_team_1_output' ) ) {
	function charity_is_hope_template_team_1_output($post_options, $post_data) {
		$show_title = true;
		...
		?>
			<div<?php echo !empty($post_options['tag_id']) ? ' id="'.esc_attr($post_options['tag_id']).'"' : ''; ?>
				...
				<div class="sc_team_item_avatar"><?php charity_is_hope_show_layout($post_options['photo']); ?></div>
				<div class="sc_team_item_info">
					...
					<?php charity_is_hope_show_layout($post_options['socials']); ?>
				</div>
			</div>
		<?php
