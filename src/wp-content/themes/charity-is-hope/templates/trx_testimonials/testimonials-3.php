...
if ( !function_exists( 'charity_is_hope_template_testimonials_3_theme_setup' ) ) {
	add_action( 'charity_is_hope_action_before_init_theme', 'charity_is_hope_template_testimonials_3_theme_setup', 1 );
	function charity_is_hope_template_testimonials_3_theme_setup() {
		charity_is_hope_add_template(array(
			'layout' => 'testimonials-3',
			'template' => 'testimonials-3',
			'mode'   => 'testimonials',
			'title'  => esc_html__('Testimonials /Style 3/', 'charity-is-hope'),
...
// Template output
if ( !function_exists( 'charity_is_hope_template_testimonials_3_output' ) ) {
	function charity_is_hope_template_testimonials_3_output($post_options, $post_data) {
		$show_title = true;
