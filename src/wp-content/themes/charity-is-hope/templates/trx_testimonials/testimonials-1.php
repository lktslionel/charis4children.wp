...
if ( !function_exists( 'charity_is_hope_template_testimonials_1_theme_setup' ) ) {
	add_action( 'charity_is_hope_action_before_init_theme', 'charity_is_hope_template_testimonials_1_theme_setup', 1 );
	function charity_is_hope_template_testimonials_1_theme_setup() {
		charity_is_hope_add_template(array(
			'layout' => 'testimonials-1',
			'template' => 'testimonials-1',
			'mode'   => 'testimonials',
			'title'  => esc_html__('Testimonials /Style 1/', 'charity-is-hope'),
...
// Template output
if ( !function_exists( 'charity_is_hope_template_testimonials_1_output' ) ) {
	function charity_is_hope_template_testimonials_1_output($post_options, $post_data) {
		$show_title = true;
