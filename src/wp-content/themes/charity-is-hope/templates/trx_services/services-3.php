...
if ( !function_exists( 'charity_is_hope_template_services_3_theme_setup' ) ) {
	add_action( 'charity_is_hope_action_before_init_theme', 'charity_is_hope_template_services_3_theme_setup', 1 );
	function charity_is_hope_template_services_3_theme_setup() {
		charity_is_hope_add_template(array(
			'layout' => 'services-3',
			'template' => 'services-3',
			'mode'   => 'services',
			'need_columns' => true,
			'title'  => esc_html__('Services /Style 3/', 'charity-is-hope'),
...
// Template output
if ( !function_exists( 'charity_is_hope_template_services_3_output' ) ) {
	function charity_is_hope_template_services_3_output($post_options, $post_data) {
