...
if ( !function_exists( 'charity_is_hope_template_services_2_theme_setup' ) ) {
	add_action( 'charity_is_hope_action_before_init_theme', 'charity_is_hope_template_services_2_theme_setup', 1 );
	function charity_is_hope_template_services_2_theme_setup() {
		charity_is_hope_add_template(array(
			'layout' => 'services-2',
			'template' => 'services-2',
			'mode'   => 'services',
			'need_columns' => true,
			'title'  => esc_html__('Services /Style 2/', 'charity-is-hope'),
...
// Template output
if ( !function_exists( 'charity_is_hope_template_services_2_output' ) ) {
	function charity_is_hope_template_services_2_output($post_options, $post_data) {
