...
if ( !function_exists( 'charity_is_hope_options_admin_menu_item' ) ) {
	//Handler of add_action('admin_menu', 'charity_is_hope_options_admin_menu_item');
...
if ( !function_exists( 'charity_is_hope_is_inherit_option' ) ) {
	function charity_is_hope_is_inherit_option($value) {
		...
		return charity_is_hope_strtolower($value)=='inherit';
	}
}
...
if ( !function_exists( 'charity_is_hope_options_load_scripts' ) ) {
	function charity_is_hope_options_load_scripts() {
		...
		if (!$loaded) {
			...
			wp_enqueue_style( 'fontello-admin-style',	charity_is_hope_get_file_url('css/fontello-admin/css/fontello-admin.css'), array(), null);
			wp_enqueue_style( 'fontello-style', 			charity_is_hope_get_file_url('css/fontello/css/fontello.css'), array(), null);
			wp_enqueue_style( 'charity-is-hope-fontello-animation-style',charity_is_hope_get_file_url('css/fontello-admin/css/animation.css'), array(), null);
			// Charity Is Hope options styles
			wp_enqueue_style( 'charity-is-hope-options-style',			charity_is_hope_get_file_url('core/core.options/css/core.options.css'), array(), null);
			wp_enqueue_style( 'charity-is-hope-options-datepicker-style',	charity_is_hope_get_file_url('core/core.options/css/core.options-datepicker.css'), array(), null);

			//RTL
			if ( is_rtl() ) {
				wp_enqueue_style( 'charity-is-hope-admin-style-rtl', charity_is_hope_get_file_url('/css/wp-admin-rtl.css', array(), null) );
			}
			...
			wp_enqueue_script( 'colors-script',		charity_is_hope_get_file_url('js/colorpicker/colors.js'), array('jquery'), null, true );
			wp_enqueue_script( 'colorpicker-script',	charity_is_hope_get_file_url('js/colorpicker/jqColorPicker.js'), array('jquery'), null, true );

			// Input masks for text fields
			wp_enqueue_script( 'jquery-input-mask',				charity_is_hope_get_file_url('core/core.options/js/jquery.maskedinput.min.js'), array('jquery'), null, true );
			...
			wp_enqueue_script( 'charity-is-hope-options-script',			charity_is_hope_get_file_url('core/core.options/js/core.options.js'), array('jquery', 'jquery-ui-core', 'jquery-ui-tabs', 'jquery-ui-accordion', 'jquery-ui-sortable', 'jquery-ui-draggable', 'jquery-ui-datepicker'), null, true );
			wp_enqueue_script( 'charity-is-hope-options-custom-script',	charity_is_hope_get_file_url('core/core.options/js/core.options-custom.js'), array('charity-is-hope-options-script'), null, true );
		
			wp_localize_script( 'charity-is-hope-options-script', 'CHARITY_IS_HOPE_OPTIONS_DATA', charity_is_hope_storage_get('to_data') );
			...
			if ($field['type'] != 'hidden') {
				...
				if ( !in_array($field['type'], array('divider'))) {
					echo '<label class="charity_is_hope_options_field_label'
						...
						. '>' 
						. ($field['title']) 
						. (!empty($field['info']) && ($fdir=charity_is_hope_get_file_url('images/to_info/'.sanitize_file_name($id).'.jpg'))!=''
...
if ( !function_exists( 'charity_is_hope_options_save' ) ) {
	//Handler of add_action('wp_ajax_charity_is_hope_options_save', 'charity_is_hope_options_save');
	//Handler of add_action('wp_ajax_nopriv_charity_is_hope_options_save', 'charity_is_hope_options_save');
...
if ( !function_exists( 'charity_is_hope_options_import' ) ) {
	//Handler of add_action('wp_ajax_charity_is_hope_options_import', 'charity_is_hope_options_import');
	//Handler of add_action('wp_ajax_nopriv_charity_is_hope_options_import', 'charity_is_hope_options_import');
