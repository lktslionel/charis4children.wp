/**
 * Charity Is Hope Framework: Admin scripts
 *
...
jQuery(document).ready(function() {
	...
	jQuery('.widgets_param_post_type_selector').on('change', function() {
		...
		charity_is_hope_admin_fill_categories(this, cat_fld, cat_lbl);
		return false;
	});
	// Set parent course
	jQuery('.charity_is_hope_course_selector').on('click', function(e) {
		"use strict";
...
function charity_is_hope_admin_fill_categories(fld, cat_fld, cat_lbl) {
	"use strict";
	var cat_value = charity_is_hope_get_listbox_selected_value(cat_fld.get(0));
