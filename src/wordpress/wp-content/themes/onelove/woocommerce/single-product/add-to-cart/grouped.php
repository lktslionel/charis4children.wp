		...
		<tbody>
			<?php
				...
				foreach ( $grouped_products as $grouped_product_child ) {
					...
					$myarr_merge = array_merge(array('label' ,'price', 'quantity'), $grouped_product_columns);
					$myarr_sort = array_unique($myarr_merge);
					foreach ( $myarr_sort as $column_id ) {
						do_action( 'woocommerce_grouped_product_list_before_' . $column_id, $grouped_product_child );
						
						switch ( $column_id ) { //td-quantity
							case 'label':
